...
class Index extends BackendBaseActionIndex
{
    ...
    private function buildQuery()
    {
        ...
        // basic query
        $query = 'SELECT l.id, l.sequence, l.title, l.num_images, l.hidden as is_hidden, l.hidden, UNIX_TIMESTAMP(l.publish_on) as publish_on, l.num_images_not_hidden,
    ...
    private function loadDataGrid()
    {
        ...
        $this->dataGrid->setColumnFunction(array('Backend\Core\Engine\DataGridFunctions', 'getLongDate'), array('[publish_on]'), 'publish_on', true);
        ...
        $this->dataGrid->setColumnFunction(array('Backend\Modules\Photogallery\Engine\Helper', 'getPreviewHTMLForAlbums50x50_crop'), array('[id]', $this->getModule(),), 'preview', true);
        $this->dataGrid->setColumnFunction(array('Backend\Modules\Photogallery\Engine\Helper', 'getNumImagesForAlbums'), array('[num_images_not_hidden]', '[num_images]'), 'num_images', true);
