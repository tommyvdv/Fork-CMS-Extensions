 ...
 */
class BackendPhotogalleryAlbums extends BackendBaseActionIndex
{
	/**
	 * Filter variables
	 *
	...
	private function loadDataGrid()
	{
		...
		// add columns
		$this->dataGrid->addColumn('edit', null, BL::getLabel('Edit'), BackendModel::createURLForAction('edit_album') . '&amp;id=[id]', BL::getLabel('Edit'));
