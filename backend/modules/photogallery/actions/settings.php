...
class BackendPhotogallerySettings extends BackendBaseActionEdit
{
	...
	private function loadForm()
	{
		...
		$this->frm->addCheckbox('force_default_category_category', BackendModel::getModuleSetting($this->URL->getModule(), 'force_default_category_category', false));
		$this->frm->addCheckbox('force_default_category_index', BackendModel::getModuleSetting($this->URL->getModule(), 'force_default_category_index', false));
		...
		$this->frm->addDropdown('show_album_count', $this->boolVals, BackendModel::getModuleSetting('photogallery', 'show_album_count', 'N'));
		$this->frm->addDropdown('album_count_unique', $this->boolVals, BackendModel::getModuleSetting('photogallery', 'album_count_unique', 'Y'));
	...
	private function validateForm()
	{
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				BackendModel::setModuleSetting($this->URL->getModule(), 'force_default_category_index', (bool) $this->frm->getField('force_default_category_index')->getValue());
				...
				BackendModel::setModuleSetting($this->URL->getModule(), 'show_album_count', $this->frm->getField('show_album_count')->getValue());
				BackendModel::setModuleSetting($this->URL->getModule(), 'album_count_unique', $this->frm->getField('album_count_unique')->getValue());
