...
<div class="pageTitle">
	<h2>{$lblProducts|ucfirst}: {$msgEditImage}</h2>
	
	<div class="buttonHolderRight">
		<a href="{$var|geturl:'edit'}&amp;id={$product_id}#tabImages" class="button icon iconBack"><span>{$lblOverview|ucfirst}</span></a>
	</div>
...
{form:edit}
	...
	<div id="pageUrl">
		...
		<div class="fullwidthOptions">
			<a href="{$var|geturl:'delete_image'}&amp;id={$record.id}&amp;product_id={$album_id}" data-message-id="confirmDelete" class="askConfirmation button linkButton icon iconDelete">
