...
<div class="pageTitle">
	<h2>{$lblModuleSettings|ucfirst}: {$lblProducts}</h2>
</div>
...
{form:settings}
	<div class="box">
		...
		<div class="options">
			<label for="overviewProductsNumberOfItems">{$lblItemsPerPage|ucfirst}</label>
			{$ddmOverviewProductsNumberOfItems}
			{$ddmOverviewProductsNumberOfItemsError}
		</div>
