...
<div class="pageTitle">
	<h2>{$lblProducts|ucfirst}: {$msgEditProduct|sprintf:{$record.title}}</h2>
	<div class="buttonHolderRight">
		<a href="{$var|geturl:'add_images_choose'}&amp;product_id={$record.id}" class="button icon iconAdd" title="{$lblAddImages|ucfirst}">
...
{form:edit}
	...
	<div class="fullwidthOptions">
		<a href="{$var|geturl:'delete'}&amp;id={$record.id}" data-message-id="confirmDeleteProduct" class="askConfirmation button linkButton icon iconDelete">
	...
	<div id="confirmDeleteProduct" title="{$lblDelete|ucfirst}?" style="display: none;">
		<p>
