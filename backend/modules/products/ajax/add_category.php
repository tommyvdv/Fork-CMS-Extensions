...
class BackendProductsAjaxAddCategory extends BackendBaseAJAXAction
{
	/**
	 * Execute the action
	 */
	public function execute()
	{
		...
		$item['sequence'] = (int) BackendProductsModel::getSequenceCategory() + 1;
		...
		$meta['url'] = BackendProductsModel::getURLForCategory($item['title']);

		// update
		$item['id'] = BackendProductsModel::insertCategory($item, $meta);
