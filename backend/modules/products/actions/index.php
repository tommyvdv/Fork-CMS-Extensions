...
/**
* This product overview action
 *
 * @author Frederik Heyninck <frederik@figure8.be>
 */
class BackendProductsIndex extends BackendBaseActionIndex
{
	/**
	 * Filter variables
	 *
	...
	private function loadDataGrid()
	{
		...
		$this->dataGrid->setColumnFunction(array('BackendProductsHelper', 'getPreviewHTMLForProducts50x50_crop'), array('[id]', $this->getModule(),), 'preview', true);
		$this->dataGrid->setColumnFunction(array('BackendProductsHelper', 'getNumImagesForProducts'), array('[num_images_not_hidden]', '[num_images]'), 'num_images', true);
		...
		$this->dataGrid->setAttributes(array('data-action' => "product_sequence"));
	}
