 ...
 */
class BackendProductsSettings extends BackendBaseActionEdit
{
	/**
	 * Execute the action
	 */
	...
	private function loadForm()
	{
		...
		$this->frm->addDropdown('overview_products_number_of_items', array_combine(range(1, 30), range(1, 30)), BackendModel::getModuleSetting($this->URL->getModule(), 'overview_products_number_of_items', 10));
	...
	private function validateForm()
	{
		if($this->frm->isSubmitted())
		{
			...
			{
				// set our settings
				BackendModel::setModuleSetting($this->URL->getModule(), 'overview_products_number_of_items', (int) $this->frm->getField('overview_products_number_of_items')->getValue());
