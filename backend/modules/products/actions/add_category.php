 ...
 */
class BackendProductsAddCategory extends BackendBaseActionAdd
{
	/**
	 * Execute the action
	 */
	...
	private function loadForm()
	{
		...
		$this->meta->setURLCallback('BackendProductsModel', 'getURLForCategory');
	}
	...
	private function validateForm()
	{
		...
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				// insert the item
				$item['id'] = BackendProductsModel::insertCategory($item);
