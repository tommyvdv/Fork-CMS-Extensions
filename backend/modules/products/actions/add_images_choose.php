...
/**
* This add images choose action
 *
 * @author Frederik Heyninck <frederik@figure8.be>
 */
class BackendProductsAddImagesChoose extends BackendBaseActionAdd
{
	/**
	 * Execute the action
	 */
	...
	private function loadForm()
	{
		...
		$rbtOptionValues[] = array('label' => SpoonFilter::ucfirst(BL::getLabel('UseExistingProduct')), 'value' => 'existing');
			...
			if($this->frm->isCorrect())
			{
				...
				switch($option)
				{
					case 'upload':
						...
						break;
					case 'existing':
						$this->redirect(BackendModel::createURLForAction('add_images_existing') . '&product_id=' . $this->id);
						break;
				}
			}
		}
