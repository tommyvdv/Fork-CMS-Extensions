 ...
 */
class BackendProductsCategories extends BackendBaseActionIndex
{
	/**
	 * Execute the action
	 */
	...
	{
		// create dataGrid
		$this->dataGrid = new BackendDataGridDB(BackendProductsModel::QRY_DATAGRID_BROWSE_CATEGORIES, BL::getWorkingLanguage());
